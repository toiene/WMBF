function  [ori_weight_mse,weight_mse,ori_weight_sKL3,weight_sKL3,y_mse,y_sKL3] = weightedihk_ind(S, Y, xpre,theta,lob,upb,epsilon)%
...
for i = 2:type
    ...
    [dmodel,~] = dacefit_ihk2_se(SX(ind,:),SY(ind,:),SH, YH,@regpoly0,@corrgauss,para.theta(i,:),...
    ...
    [ypre,msepre] = predictor_ihk2(xpre,dmodel);
