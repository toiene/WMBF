function  [dmodel, perf] = dacefit_ihk2_extended_f2(SL1, YL1, SL2, YL2, SH, YH, regr, corr, theta0, lob, upb)
...
% Normalize data
mS = mean([SL1; SL2; SH]);   sS = std([SL1; SL2; SH]);
mY = mean([YL1; YL2; YH]);   sY = std([YL1; YL2; YH]);
...
MSE = 1./(1./MSE_1 + 1./MSE_2);
ff_p = MSE.*(ff_p1./MSE_1 + ff_p2./MSE_2);
...
dmodel = struct('regr',regr, 'corr',corr, 'theta',theta.', ...
  ...
  'C',fit.C, 'Ft',fit.Ft, 'G',fit.G, 'dmc_1', dmodel1_1, 'dmc_2', dmodel1_2);
